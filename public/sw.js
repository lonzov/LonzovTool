  ...
  if (event.data?.type === 'GET_POPUP_DATA') {
    event.ports[0]?.postMessage({
      ...
      popupData: {
        ...
        <h4>👾 更新日志：</h4>
        <p>[+] 下载页+2：HOSDLA工具箱、AIEX-FMBE编辑器<br>[+] 本站支持作为PWA应用安装到本地<br>[+] 指令音符盒同步新版本v2.5<br>[+] 加入设置页，允许导出配置<br>[+] 新卡片：HOSDLA工具箱、AIEX-FMBE编辑器、网易版存档解密、FMBE专区、Aura Music</p>
