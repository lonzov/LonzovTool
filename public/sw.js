  ...
  if (event.data?.type === 'GET_POPUP_DATA') {
    event.ports[0]?.postMessage({
      ...
      popupData: {
        ...
        <h4>👾 更新日志：</h4>
        <p>[+] T显编辑器支持translate嵌套编辑<br>[+] 首页加入收藏卡片功能<br>[~] 优化文档页markdown样式<br>[+] 部分元素圆角改用超椭圆(需浏览器支持)<br>[+] 重构T显可视化编辑器<br>[+] 特殊符号页添加预览验证功能<br>[+] 新卡片：Paul指令社区、MC指令音乐站<br>[+] 下载页支持选择历史版本</p>
        `,
        buttons: [
